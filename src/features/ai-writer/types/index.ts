...
export interface ClusterData {
  ...
  // Optional: supporting keywords for cluster articles, with suggested placement.
  // Uses the same structure as pillar sub-keywords for consistent rendering.
  supportingKeywords?: SubKeyword[]
}
