/**
 * ============================================
 * VIDEO HIJACK - MOCK DATA GENERATORS
 * ============================================
 * 
 * Functions to generate mock data for development/demo
 */

import type { VideoResult, TikTokResult, KeywordStats, VideoSuggestion, Platform } from "../types/video-hijack.types"
...
/**
 * Generate keyword stats for a platform
 */
