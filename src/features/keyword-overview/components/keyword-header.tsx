  ...
  return (
    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        <h1 className="text-2xl lg:text-3xl font-bold text-white">{metrics.keyword}</h1>
        <div className="flex flex-wrap items-center gap-2">
          <span className="px-2.5 py-1 text-xs lg:text-sm font-medium bg-blue-500/20 text-blue-400 rounded-full border border-blue-500/30">
            Volume: {metrics.volume}
          </span>
          <span className="px-2.5 py-1 text-xs lg:text-sm font-medium bg-red-500/20 text-red-400 rounded-full border border-red-500/30">
            KD: {metrics.kdLabel} ({metrics.kd}%)
          </span>
          <span className="px-2.5 py-1 text-xs lg:text-sm font-medium bg-emerald-500/20 text-emerald-400 rounded-full border border-emerald-500/30">
            CPC: {metrics.cpc}
          </span>
          <span className="px-2.5 py-1 text-xs lg:text-sm font-medium bg-cyan-500/20 text-cyan-400 rounded-full border border-cyan-500/30 flex items-center gap-1.5">
      ...
      <div className="flex items-center gap-2 lg:gap-3">
        <Button variant="outline" size="sm" className="border-slate-700 text-slate-300 hover:bg-slate-800 bg-transparent text-xs lg:text-sm">
