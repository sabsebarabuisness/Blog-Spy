  ...
  return (
    <div className="bg-card dark:bg-gradient-to-br dark:from-card/80 dark:to-cyan-900/20 border border-cyan-500/30 rounded-xl p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-xs text-cyan-600 dark:text-cyan-400 bg-cyan-500/10 px-2 py-0.5 rounded-full">
          High Opportunity
        </span>
      </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="text-emerald-600 dark:text-emerald-400">{components.citationFreshness}/25</span>
        </div>
        <div className="flex items-center justify-between text-xs">
          <span className="text-muted-foreground flex items-center gap-1">
            <Shield className="w-3 h-3" /> Authority Gap
          </span>
          <span className="text-emerald-600 dark:text-emerald-400">{components.authorityWeakness}/25</span>
        </div>
        <div className="flex items-center justify-between text-xs">
          <span className="text-muted-foreground flex items-center gap-1">
            <Video className="w-3 h-3" /> Media Gap
          </span>
          <span className="text-amber-600 dark:text-amber-400">{components.mediaGap}/25</span>
        </div>
        <div className="flex items-center justify-between text-xs">
          <span className="text-muted-foreground flex items-center gap-1">
            <FileText className="w-3 h-3" /> Text Quality
          </span>
          <span className="text-amber-600 dark:text-amber-400">{components.textQuality}/25</span>
        </div>
      </div>
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-sm font-medium text-muted-foreground">Global Interest</h3>
      </div>
      <WorldMap />
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="text-sm font-medium text-muted-foreground">Intent Profile</h3>
      </div>
      <RadarChart />
      <div className="flex items-center gap-2 mt-2 px-2 py-1.5 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
        <Video className="w-4 h-4 text-cyan-500 dark:text-cyan-400" />
        <span className="text-xs text-cyan-600 dark:text-cyan-300">High Video Intent detected</span>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-sm font-medium text-muted-foreground">Trend Forecast</h3>
      </div>
      <SeasonalityChart />
      <div className="flex items-center gap-2 mt-3 px-2 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-lg">
        ...
        <span className="text-xs text-amber-600 dark:text-amber-300">Peak in 3 months. Publish now to rank.</span>
      </div>
    </div>
  )
}
